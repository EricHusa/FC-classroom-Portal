<template>
    <div>
        ...
        <b-col sm="6">
           ...
           <b-img v-bind:src="image_url_with_ts" fluid  alt="No image to show" class="zoom"/><br /><hr>
      ...
      locale="en"
    ></b-form-datepicker>
            <b-btn @click="fetchImage" variant="success" dark class="mb-2 image-reset" v-b-popover.hover.top="'Images are typically updated every hour'">Get newest image</b-btn>
        </b-jumbotron>
        </b-col>
        ...
        <b-col sm="6">
           ...
           <b-img v-bind:src="image_url_with_ts" fluid  alt="No video to show" class="zoom"/><br /><hr>
            <b-row>
                <b-col sm="6">
    ...
    ></b-form-datepicker>
            ...
            <b-btn @click="fetchImage" variant="danger" dark class="mb-2 image-reset" >Clear this video</b-btn>
                </b-jumbotron>
            </b-col>
            </b-row>
        </div>
